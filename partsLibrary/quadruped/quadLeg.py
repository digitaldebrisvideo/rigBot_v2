...
class QuadLeg(standardPart.StandardPart):
    ...
    def build_guide(self, **kwargs):
        ...
        for i in range(number_twist_jnts):
            ...
            mc.pointConstraint(mid_leg_plc, plc, weight=(div*(i+1)))
        ...
        if up_twist_jnts:
            mc.parent(mid_leg_jnt, up_twist_jnts[-1])
    ...
    def build_rig(self):
        ...
        # connect the midleg usuing orient contraint then direct connections to avoid cycling
        ...
        # connect the midleg usuing orient contraint then direct connectns to avoid cycling
        ...
        if up_leg_twist_jnts:
            ikChain.upper_twist(utils.get_parent(sec_up_leg_ik_jnt), sec_up_leg_ik_jnt, sec_mid_leg_ik_jnt, up_leg_jnt, mid_leg_jnt, up_leg_twist_jnts)
            ikChain.lower_twist(sec_lo_leg_ik_jnt, sec_leg_end_ik_jnt, lo_leg_jnt, lo_leg_twist_jnts, leg_end_jnt)

            ikChain.stretch_twist_jnts(sec_up_leg_ik_jnt, sec_mid_leg_ik_jnt, up_leg_twist_jnts)
