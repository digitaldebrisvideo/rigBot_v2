...
arms = ["shoulder_Lt_jnt", "shoulder_Rt_jnt"]
legs = ["thigh_Lt_jnt", "thigh_Rt_jnt"]
...
def apply_ik(x):
    ...
    ikh[0] = pm.rename(ikh[0],hnd)
    ikh[1] = pm.rename(ikh[1],eff)
